...
description: Hunt for obvious, direct contradictions in user-provided information. Statements that explicitly conflict with each other. Use as part of the contradiction-hunter skill workflow.
model: opus
---
