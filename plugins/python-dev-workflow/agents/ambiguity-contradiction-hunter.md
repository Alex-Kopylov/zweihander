...
description: Hunt for hidden contradictions behind vague language, ambiguous terms, and assumption gaps in user-provided information. Use as part of the contradiction-hunter skill workflow.
model: opus
---
