...
- Use `Write` when saving the final contradiction summary report.
- Treat `$ARGUMENTS` as the invocation arguments supplied by the slash-command-style skill call.
