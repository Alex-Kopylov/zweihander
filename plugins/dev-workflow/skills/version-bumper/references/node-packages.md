...
- If lockfiles are present, update them only when the package manager normally records the root package version there or the user asks for lockfile updates.
