...
Invoke $work-session-tools:daily with optional `output-dir`.
...
include Codex project instructions such as `AGENTS.md` and Codex settings or
MCP configuration exposed in the active environment. Use Codex MCP tools,
apps, or resources available in the active tool list for Slack, Microsoft
Teams, Telegram, Azure DevOps, and custom MCP sources.
