...
Treat `./.codex.local.md` as local personal settings and `~/.codex/AGENTS.md`
as user-wide defaults when explaining context locations. Account for
parent-directory and nested `AGENTS.md` discovery in monorepos.
...
After outputting the quality report, ask the user for confirmation with $request_user_input before updating.
