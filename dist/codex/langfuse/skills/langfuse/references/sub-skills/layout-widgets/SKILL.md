...
name: layout-widgets
description: >
  Use when calculating Langfuse dashboard widget grid positions. Trigger
  phrases: "layout widgets", "widget placement", "grid position", "arrange
  widgets", "widget positioning". Computes x/y coordinates and sizes for the
