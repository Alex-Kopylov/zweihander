...
description: Hunt for deeper structural and logical inconsistencies in user-provided information. Requirements that are technically incompatible, scope mismatches, and implicit assumption clashes. Use as part of the spec-contradiction-hunter skill workflow.
model: opus
---
