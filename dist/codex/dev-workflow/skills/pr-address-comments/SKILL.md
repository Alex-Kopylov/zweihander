...
Ask the user with $request_user_input to choose which comments to address, using a bounded multi-select choice. Include an "All of them" option as the first choice.
