...
1. **Extract work item ID** from current branch name:
   ...
   - If no ID found → ask the user with $request_user_input
...
4. **Ask user to confirm** the drafted comment with $request_user_input before posting — always, no exceptions
