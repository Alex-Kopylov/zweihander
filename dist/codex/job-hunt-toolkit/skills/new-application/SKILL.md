...
- Check `<workspace>/<slug>/` doesn't already exist. If it does, ask with $request_user_input:
...
- **Tailor now** → invoke $job-hunt-toolkit:resume-tailoring with the JD and this company's HTML as context
...
| Master HTML not found | Stop; ask user to create one or use $job-hunt-toolkit:init-workspace |
