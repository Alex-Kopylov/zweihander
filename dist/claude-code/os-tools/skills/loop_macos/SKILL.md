...
This skill mirrors the built-in `/loop` interval and "every" input syntax.
...
If the resulting task is empty after parsing, ask the user with Skill(AskUserQuestion) what they want to schedule. Don't proceed.
