...
- After Skill(job-hunt-toolkit:export-pdf) runs and before Skill(job-hunt-toolkit:prepare-to-send) declares the file ready.
...
Ready for sending. Run Skill(job-hunt-toolkit:prepare-to-send) for the full pre-send checklist.
```
