...
1. **Extract work item ID** from current branch name:
   ...
   - If no ID found → ask the user with Skill(AskUserQuestion)
...
4. **Ask user to confirm** the drafted comment with Skill(AskUserQuestion) before posting — always, no exceptions
