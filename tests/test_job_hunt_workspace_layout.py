...
# Skills carrying harness-specific wording are authored as Jinja templates and
# render to SKILL.md per harness under dist/.
EXPORT_PDF_SKILL = PLUGIN / "skills/export-pdf/SKILL.md.j2"
...
def test_new_application_enforces_slug_regex_and_jobs_prefix() -> None:
    skill = (PLUGIN / "skills/new-application/SKILL.md.j2").read_text(encoding="utf-8")
